...
cmu_spatial_data_input_path <- paste0(data_base_path, "/spatial/ncdmf_data_raw/")

# path to rainfall threshold tabular inputs
rainfall_thresh_tabular_data_input_path <- paste0(data_base_path, "/tabular/ncdmf_data_raw/")

# outputs
# path to cmu spatial outputs
cmu_spatial_data_output_path <- paste0(data_base_path, "/spatial/ncdmf_data_tidy/")

# path to rainfall threshold tabular outputs
rainfall_thresh_tabular_data_output_path <- paste0(data_base_path, "/tabular/ncdmf_data_tidy/")
...
# sga key
sga_key <- read_csv(paste0(rainfall_thresh_tabular_data_output_path, "sga_key.csv"), col_names = TRUE)

# cmu to sga key
cmu_sga_key <- read_csv(paste0(rainfall_thresh_tabular_data_output_path, "cmu_sga_key.csv"), col_names = TRUE)
